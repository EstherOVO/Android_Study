...
import com.busanit.ch08_activity.intent.Intent01Activity
import com.busanit.ch08_activity.intent.Intent02Activity
...
//              첫 번째 매개변수 : Context, 두 번째 매개변수 : Activity 클래스 리플렉션
                val intent = Intent(this@MainActivity, Intent01Activity::class.java)
...
//              인텐트로 공유 기능 사용
//              인텐트 객체 생성하고 apply 스코프 함수 속성 설정
...
//              첫 번째 매개변수 공유할 인텐트, 두 번째 매개변수는 제목
...
//          명시적 인텐트에 데이터를 담아 보내기
            ...
            button7.setOnClickListener {
                val intent = Intent(this@MainActivity, Intent02Activity::class.java)
                    .apply {
...
//          Contract 객체를 생성 : 다른 Activity에 갔다 올 경우
...
//              인텐트 객체 생성
                val intent = Intent(this@MainActivity, Intent02Activity::class.java)
                intent.putExtra("extra_msg", "Result API에서 보낸")
