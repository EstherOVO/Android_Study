...
import com.busanit.ch08_activity.databinding.ActivityIntent02Binding

// 인텐트 결과 반환
class Intent02Activity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        val binding = ActivityIntent02Binding.inflate(layoutInflater)
